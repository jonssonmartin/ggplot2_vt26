...
gapminder %>% 
  ggplot(aes(x=continent, 
             ...
             fill=continent, # <1>
             shape=continent))+
  geom_boxplot(outliers=F)+ # <3>
  scale_fill_manual(values=c("#16697a", "#489fb5", "#82c0cc", "#c32f27", "#ffa62b"))+ # <2>
  labs(x="Continent",
       y="GDP per capita",
...
I examinationsuppgiften ska en figur/visalisering ingå

-   Resten av dagen kan användas till att göra en sådan examination
