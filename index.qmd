...
gapminder %>% group_by(continent) %>% summarise(median = median(gdpPercap))
...
```{r}
#| classes: shrink-code
if (!require('ggpie')) install.packages('ggpie'); library('ggpie') # <1>

gapminder %>% filter(year==2007) %>% # <2>
ggpie(group_key = "continent", count_type = "full", label_info = "all", # <3>
